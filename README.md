...
#Getting started 
This README covers creating a basic Slack app tailored to work with Bolt. While we glance over some configuration, there is a more general [app setup](https://api.slack.com/authentication/basics) guide that goes into greater detail.
